    ...
    <div className="flex flex-col gap-4">
          ...
          <Select
            ...
            value={
              categoryOptions.find(
                (option) => option.value === newProperty.category,
              ) || null
            }
            onChange={(
              option: SingleValue<{
      ...
      <div className="grid gap-2">
        ...
        <CountrySelect
          value={countryValue}
          onChange={(value) =>
            setCustomValue("countryValue", value?.value || "")
          }
        />
      </div>
      <div className="grid grid-cols-4 gap-4">
        <div className="grid gap-2">
          ...
          <Input
            ...
            onChange={(e) =>
              setCustomValue("price", Number.parseInt(e.target.value) || 0)
            }
          />
        </div>
        <div className="grid gap-2">
          ...
          <Input
            ...
            onChange={(e) =>
              setCustomValue("bedrooms", Number.parseInt(e.target.value) || 1)
            }
          />
        </div>
        <div className="grid gap-2">
          ...
          <Input
            ...
            onChange={(e) =>
              setCustomValue("bathrooms", Number.parseInt(e.target.value) || 1)
            }
          />
        </div>
        <div className="grid gap-2">
          ...
          <Input
            ...
            onChange={(e) =>
              setCustomValue("guestCount", Number.parseInt(e.target.value) || 1)
            }
          />
        </div>
      </div>
