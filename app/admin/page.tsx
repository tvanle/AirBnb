        ...
        <TabsContent value="overview" className="space-y-4">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
            <Card className="col-span-4">
              ...
              <CardFooter>
                <a href="/bookings" className="text-sm text-blue-500 hover:underline flex items-center">
                  View all bookings
            ...
            <Card className="col-span-3">
              ...
              <CardFooter>
                <a href="/properties" className="text-sm text-blue-500 hover:underline flex items-center">
                  View all properties
                  <ArrowRight className="ml-1 h-4 w-4" />
                </a>
              </CardFooter>
